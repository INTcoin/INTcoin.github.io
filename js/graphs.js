...
async function updateDifficultyGraph(eth, num_days, num_search_points){
  ...
  */
  ...
  // var a = await eth.getStorageAt('0x012fd5049a203df08c02fb2e0ed15ceed10d9ed4', new Eth.BN('20', 10), 'latest');
  // var b = await eth.getStorageAt('0x012fd5049a203df08c02fb2e0ed15ceed10d9ed4', new Eth.BN('20', 10), 'earliest');
  // console.log(a, b);
