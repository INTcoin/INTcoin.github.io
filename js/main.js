...
const _CONTRACT_ADDRESS = "0x012fd5049a203df08c02fb2e0ed15ceed10d9ed4";
...
const _ETH_BLOCKS_PER_REWARD = 15;
...
stats = [
  ...
  ['Tokens Minted',                 token.tokensMinted,                   "0xLTC",      0.00000001, null     ], /* supply */
  ['Max Supply for Current Era',    token.maxSupplyForEra,                "0xLTC",      0.00000001, null     ], /* mining */
  ['Supply Remaining in Era',       null,                                 "0xLTC",      0.00000001, null     ], /* mining */
  ...
  ['Current Mining Reward',         token.getMiningReward,                "0xLTC",      0.00000001, null     ], /* mining */
  ['Epoch Count',                   token.epochCount,                     "",           1,          null     ], /* mining */
  ['Total Supply',                  token.totalSupply,                    "0xLTC",      0.00000001, null     ], /* supply */
...
function updateStatsThatHaveDependencies(stats) {
  ...
  el_safe('#SupplyRemaininginEra').innerHTML = "<b>" + supply_remaining_in_era.toLocaleString() + "</b> 0xLTC <span style='font-size:0.8em;'>(" + rewards_blocks_remaining_in_era + " blocks)</span>";
